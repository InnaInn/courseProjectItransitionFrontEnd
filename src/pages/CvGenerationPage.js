    ...
    if (!user) {
        return (
            <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col transition-colors">
                <Header />
                <div className="flex-grow container mx-auto px-2 sm:px-4 py-3 sm:py-6">
                    <div className="text-center text-red-500 dark:text-red-400 text-sm sm:text-base">{t('userNotFound') || 'User not found'}</div>
                </div>
                <Footer />
            </div>
        );
            ...
            <div className="flex-grow container mx-auto px-2 sm:px-4 py-3 sm:py-6">
                <div className="max-w-5xl mx-auto">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden relative transition-colors">
                        {!isRecruiter && isEditing && (
                            <div className="absolute top-2 right-2 sm:top-4 sm:right-4 z-20 flex gap-2">
                                <button
                                    ...
                                    className="px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors shadow-md border border-gray-200 dark:border-gray-600"
                                >
                                    {t('cancel')}
                                </button>
                                <button
                                    onClick={handleSaveProfile}
                                    className="px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 transition-colors shadow-md"
                                >
                                    {t('save')}
                                </button>
                            </div>
                        ...
                        {isRecruiter && (
                            <div className="absolute top-2 right-2 sm:top-4 sm:right-4 z-20 flex flex-wrap items-center gap-2">
                                <button
                                    onClick={handleInvite}
                                    className="bg-green-600 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-md text-xs sm:text-sm font-medium hover:bg-green-700 transition-colors shadow-md"
                                >
                                    {t('inviteToInterview') || 'Invite to interview'}
                                </button>
                                {showInviteMessage && (
                                    <span className="text-xs sm:text-sm text-green-600 dark:text-green-400 font-medium animate-pulse">
                        ...
                        {!isRecruiter && isEditing ? (
                            <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-4 sm:px-8 py-6 sm:py-10">
                                <div className="flex flex-col items-center text-center gap-4">
                                    <div>
                                        <img
                                            src={editForm.photoUrl || candidatePhoto}
                                            alt="Candidate"
                                            className="w-24 h-24 sm:w-36 sm:h-36 rounded-full object-cover shadow-lg border-4 border-white/30"
                                        ...
                                        <input
                                            ...
                                            className="mt-2 w-full px-3 py-1 border border-white/30 rounded-md bg-white/20 text-white text-xs sm:text-sm placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white"
                                    ...
                                    <div className="text-white w-full max-w-lg space-y-3">
                                        <div className="flex flex-col sm:flex-row gap-2">
                                            <input
                                                ...
                                                className="flex-1 px-3 py-2 border border-white/30 rounded-md bg-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white text-sm sm:text-base"
                                            />
                                            <input
                                                type="text"
                                        ...
                                        <input
                                            ...
                                            className="w-full px-3 py-2 border border-white/30 rounded-md bg-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white text-sm sm:text-base"
                                        />
                                        <input
                                            type="email"
                                    ...
                                    <div className="mt-4 w-full">
                                        <textarea
                                            ...
                                            rows="4"
                                            className="w-full px-4 py-3 border border-white/30 rounded-lg bg-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white text-sm sm:text-base"
                            ...
                            <>
                                <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-4 sm:px-8 py-8 sm:py-12 relative">
                                    {!isRecruiter && (
                                        <button
                                            onClick={startEdit}
                                            className="absolute top-2 right-2 sm:top-4 sm:right-4 z-10 bg-white dark:bg-gray-700 rounded-full p-1.5 sm:p-2.5 shadow-md hover:shadow-lg hover:scale-105 transition-all border border-gray-200 dark:border-gray-600"
                                        >
                                            <img src={editImg} alt={t('edit')} className="w-4 h-4 sm:w-5 sm:h-5" />
                                        </button>
                                    )}
                                    <div className="flex flex-col items-center text-center gap-6">
                                        ...
                                        <div className="text-white">
                                            ...
                                            <div className="flex flex-wrap justify-center gap-x-4 sm:gap-x-8 gap-y-2 text-white/90 text-sm sm:text-base">
                                ...
                                <div className="p-4 sm:p-10">
                                    {position && (
                                        <div className="mb-8">
                                            <div className="flex items-center gap-3 mb-4">
                                                ...
                                                <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-100">{t('appliedPosition') || 'Applied Position'}</h2>
                                            </div>
                                            <div className="bg-purple-50 dark:bg-purple-900/30 rounded-xl p-4 sm:p-5 border border-purple-100 dark:border-purple-800">
                                                <h3 className="text-lg sm:text-xl font-semibold text-gray-800 dark:text-gray-100">{position.name}</h3>
                                                <p className="text-gray-600 dark:text-gray-400 mt-2 text-sm sm:text-base">{position.description}</p>
                                                {positionAttributes.length > 0 && (
                                                    <div className="mt-3">
                                                        <p className="text-sm sm:text-base font-medium text-gray-700 dark:text-gray-300 text-left">{t('requirements')}:</p>
                                                        <div className="flex flex-col space-y-1 mt-1 text-left">
                                                            {positionAttributes.map((attr) => (
                                                                <div key={attr.id} className="text-gray-700 dark:text-gray-400 text-xs sm:text-sm text-left">
                                                                    {attr.name}
                                                                </div>
                                                            ))}
                                                        </div>
                                    ...
                                    <div className="mb-8">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-100">{t('aboutMe') || 'About Me'}</h2>
                                        </div>
                                        <p className="text-gray-700 dark:text-gray-300 text-sm sm:text-base leading-relaxed bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 sm:p-5 border border-gray-100 dark:border-gray-600">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                                        <div>
                                            <div className="flex items-center justify-between mb-4">
                                                <div className="flex items-center gap-3">
                                                    <span className="w-1 h-8 bg-blue-600 rounded-full"></span>
                                                    <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-100">{t('positionRequirements') || 'Position Requirements'}</h2>
                                                </div>
                                                {!isRecruiter && (
                                                    <ToolBar
                                            ...
                                            {positionAttributes.length === 0 ? (
                                                <p className="text-gray-500 dark:text-gray-400 text-center py-6 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-100 dark:border-gray-600 text-sm sm:text-base">{t('noRequirements') || 'No requirements for this position'}</p>
                                            ) : (
                                                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 sm:p-5 border border-gray-100 dark:border-gray-600 space-y-2">
                                                    {positionAttributes.map((attr) => {
                                                        ...
                                                        return (
                                                            <div key={attr.id} className="flex items-center justify-between py-1.5 border-b border-gray-100 dark:border-gray-600 last:border-0">
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <span className={`text-sm sm:text-base font-medium ${!hasSkill ? 'text-red-600 dark:text-red-400' : 'text-gray-700 dark:text-gray-300'}`}>
                                                                        {attr.name}
                                                                    </span>
                                                                    {!hasSkill && (
                                                                ...
                                                                <div className="flex items-center gap-2">
                                                                    {hasSkill ? (
                                                                        <span className="text-xs sm:text-sm bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 px-3 py-1 rounded-full border border-green-200 dark:border-green-700">
                                                                            {userValue}
                                                                        </span>
                                                                    ) : (
                                                                        <span className="text-xs sm:text-sm text-gray-400 dark:text-gray-500 px-3 py-1 rounded-full border border-gray-200 dark:border-gray-600">
                                        ...
                                        <div>
                                            <div className="flex items-center justify-between mb-4">
                                                <div className="flex items-center gap-3">
                                                    <span className="w-1 h-8 bg-blue-600 rounded-full"></span>
                                                    <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-100">{t('projects')}</h2>
                                                </div>
                                                {!isRecruiter && (
                                                    <ToolBar
                                            ...
                                            {projects.length === 0 ? (
                                                <p className="text-gray-500 dark:text-gray-400 text-center py-6 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-100 dark:border-gray-600 text-sm sm:text-base">{t('noProjects')}</p>
                                            ) : (
                                                <div className="space-y-4">
                                                    {projects.map((project) => (
                                                        <div key={project.id} className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 sm:p-5 border border-gray-100 dark:border-gray-600 hover:shadow-md transition-shadow">
                                                            <div className="flex items-start justify-between">
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <h3 className="font-semibold text-gray-800 dark:text-gray-100 text-base sm:text-lg">{project.name}</h3>
                                                                </div>
                                                                {project.startDate && project.endDate && (
                                                                    <span className="text-xs text-gray-400 dark:text-gray-500 bg-white dark:bg-gray-800 px-2 sm:px-3 py-1 rounded-full border border-gray-200 dark:border-gray-600 whitespace-nowrap ml-2">
                                                                        {project.startDate} — {project.endDate}
                                                                    </span>
                                                                )}
                                                            </div>
                                                            <p className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm mt-2 leading-relaxed ml-6">
