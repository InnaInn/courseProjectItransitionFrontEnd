                ...
                <div className="flex items-start gap-6">
                    ...
                    <div className="flex-grow space-y-3">
                        ...
                        <div className="flex items-baseline gap-3">
                            ...
                            <span className="text-gray-800 text-lg">ivan@yandex.ru</span>
                        </div>
                        <div className="flex items-baseline gap-3">
                            <span className="text-gray-600 font-medium text-lg">Position:</span>
                            <span className="text-gray-800 text-lg">Frontend-Developer</span>
                        </div>
                        <div className="flex items-baseline gap-3">
