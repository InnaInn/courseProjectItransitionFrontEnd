...
function CandidateProfileProjects({ userId }) {
    ...
    const handleConfirmDelete = async () => {
        const success = await deleteProjects(pendingDeleteIds);
    ...
    if (!projects || projects.length === 0) {
        return (
            <div className="bg-white rounded-xl shadow-lg p-8 max-w-7xl mx-auto relative">
